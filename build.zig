...
pub fn build(b: *std.Build) !void {
	...
	// Make 'main' module point to server_exe's own root_module so all 'main.' imports resolve to server_main's exports
	server_exe.root_module.addImport("main", server_exe.root_module);
